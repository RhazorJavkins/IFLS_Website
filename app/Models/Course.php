...
class Course extends Model
{
    ...
    protected $fillable = ['program_id', 'name', 'description', 'level', 'price', 'duration', 'max_students', 'is_active', 'sort'];
    ...
    // Kelas berada di bawah satu program (restrukturisasi Fase 5)
